...
(defgroup doom-tokyo-moon-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom doom-tokyo-moon-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-tokyo-night-theme
  :type 'boolean)

(defcustom doom-tokyo-moon-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-tokyo-night-theme
  :type 'boolean)

(defcustom doom-tokyo-moon-comment-bg doom-tokyo-moon-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their legibility."
  :group 'doom-tokyo-night-theme
  :type 'boolean)

(defcustom doom-tokyo-moon-padded-modeline nil
...
(def-doom-theme doom-tokyo-moon
